...
/*   Updated: 2018/11/07 20:05:52 by abiri            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*putsizet(long long nb, t_print *data)
{
	if ((data->arg)[0] == 'z')
	{
		...
		if (ft_strchr("oOxXuU", data->arg[1]))
